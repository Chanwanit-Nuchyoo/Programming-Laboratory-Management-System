...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2016 at 02:26 AM
...
CREATE TABLE `syllabus` (
  ...
  `items_max` int(2) UNSIGNED DEFAULT NULL,
  `full_mark` int(2) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `syllabus` (`syllabus_id`, `chapter`, `description`, `items_max`, `full_mark`) VALUES
...
INSERT INTO `user_student` (`stu_id`, `stu_name`, `stu_surname`, `stu_nickname`, `stu_password`, `stu_email`, `added_date`, `stu_phone`, `avatar`, `stu_group`, `dept_id`) VALUES
(59990001, '1', '1', NULL, 'a6e372195f7e4f90b5361ea942875aec', NULL, '2016-12-04 08:12:27', NULL, NULL, 1, 99),
(59990002, '2', '2', NULL, 'ce909e1362926f6fd2cca24e77b0b7d5', NULL, '2016-12-04 08:15:52', NULL, NULL, 1, 99),
(59990003, '3', '3', NULL, '81a780723e8afb5ed2b3c9cacf6f3fa1', NULL, '2016-12-04 08:17:25', NULL, NULL, 1, 99);
