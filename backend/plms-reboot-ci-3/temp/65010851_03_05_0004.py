 ...
 * chapter : 3	item : 5	ครั้งที่ : 0004
 * Assigned : Monday 15th of August 2022 07:38:14 PM --> Submission : Wednesday 17th of August 2022 08:02:36 PM	
 * Elapsed time : 2904 minutes.
 * filename : ch3_5.py
'''
...
try :
    ...
    second = int(second)
    w = (str(second // 684800) + " weeks ") * ((second // 684800) > 0) #str * bool
