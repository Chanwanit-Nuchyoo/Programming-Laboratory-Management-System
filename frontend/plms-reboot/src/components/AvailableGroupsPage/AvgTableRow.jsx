...
const AvgTableRow = ({
  ...
  return (
    <Grid container sx={{ minHeight: "26px", padding: "15px 0px", background: "var(--biscay)", borderRadius: "8px", cursor: "pointer", ":hover": { bgcolor: "var(--hover)" } }}>
      <Grid lg={1.5} className="flex-center" sx={{ padding: "0px 2.5px" }} >
        <Typography>{groupId}</Typography>
      </Grid>
      <Grid md={1.5} className="flex-center" sx={{ padding: "0px 2.5px" }} >
      ...
      <Grid md={3} className="flex-center" sx={{ padding: "0px 2.5px" }} >
        <TimeSchedule classDate={classDate} />
      </Grid>
      <Grid md={1} className="flex-center" sx={{ padding: "0px 2.5px" }} >
        <Typography>
          {students}
        </Typography>
      </Grid>
      <Grid md={2} className="flex-start" sx={{ padding: "0px 2.5px" }} >
