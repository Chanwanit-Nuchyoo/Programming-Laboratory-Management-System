...
const EditGroup = () => {
    ...
    const { data: classScheduleData, isLoading: isClassScheduleLoading, isFetching } = useClassScheduleQuery(groupId);

    const items = [{ label: 'My Groups', href: '/ins' }];
    const form = !isClassScheduleLoading && !isFetching && classScheduleData ? {
